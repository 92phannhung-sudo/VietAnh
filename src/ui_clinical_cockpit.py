...
class ClinicalCockpitWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.camera_label.setStyleSheet("background-color: #020617; border: 2px dashed #38bdf8; border-radius: 8px; color: #38bdf8; font-weight: bold;")
        ...
        self.baseline_title.setStyleSheet("color: #f8fafc; font-weight: bold;")
        base_layout.addWidget(self.baseline_title)

        self.baseline_label = QLabel("[Chưa có ảnh Baseline]")
